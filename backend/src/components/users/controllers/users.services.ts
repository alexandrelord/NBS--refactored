...
export const loginUser = async (email: string, password: string) => {
    ...
    if (user.accountType.name === 'local' && user.password) {
...
/**
 * @param {*} googleProfile - The google profile object
 * @returns {object} - Returns a user object
 *
 * This function creates a new google user and returns the user object
 */
